...
SECRET_KEY = 'django-insecure-xqc8izx8n9t7m_5_1^-flct@)zg&euvqfxnp4pdd__@tq%=)#8'
...
if os.environ.get('K_REVISION', None):
    ...
    'default': {
        ...
        'NAME': 'postgres', 
        'USER': 'postgres',  
        'PASSWORD': 'nkiramacumu8@@',  
        'HOST': '/cloudsql/financial-439004:us-central1:financial-db-instance',   
    }
}
